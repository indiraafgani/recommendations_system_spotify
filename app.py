...
section[data-testid="stSidebar"] .stButton > button:hover {
    background: rgba(252,230,143,0.24) !important;
...
if user_id or find_btn:
    ...
    if not uid:
        ...
        if source == "ALS":
            ...
            badge_text  = f"◈ Content-Based Hybrid &nbsp;·&nbsp; {n_inter} song(s) in history"
        else:
            badge_class = "badge-pop"
            badge_text  = "◉ Popularity-Based &nbsp;·&nbsp; New listener"
        ...
        if profile is not None:
            ...
            with col_p:
                st.markdown(f"""
                <div class="panel">
                    <div class="panel-title">Your Audio Profile</div>
                    {bars_html}
